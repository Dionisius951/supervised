...
wheelbase = st.number_input("Wheelbase (dalam inch)", step=0.1)
carwidth = st.number_input("Lebar Mobil (dalam inch)", step=0.1)
carlength = st.number_input("Panjang Mobil (dalam inch)", step=0.1)
curbweight = st.number_input("Berat Mobil (dalam lbs)", step=0.1)
engineSize = st.number_input("Ukuran Mesin (in³)", step=0.1)
